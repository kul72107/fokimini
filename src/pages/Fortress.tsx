    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        ...
        >
          ...
          <a href={`${import.meta.env.BASE_URL}login`} className="inline-block px-6 py-3 bg-purple-primary text-white rounded-2xl border-4 border-black font-fredoka font-bold hover:bg-purple-dark transition-colors">
            Go to Login
          </a>
        </motion.div>
      </div>
