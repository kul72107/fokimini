...
export default function ARPSpooferGUI({ onScoreChange }: Props) {
  ...
  const [deviceArpCache, setDeviceArpCache] = useState<Record<string, { ip: string; mac: string; spoofed: boolean }[]>>({});
  ...
  }, [selectedVictim, selectedTarget, sendARPPacket, totalScore, onScoreChange, mitmPositionScore]);
  ...
  }, [mitmActive, selectedVictim, selectedTarget, totalScore, onScoreChange]);
