            ...
            <div className="w-full bg-purple-pale rounded-xl border-[3px] border-black p-3">
              <div className="flex items-center justify-center gap-4">
                <div className="flex flex-col items-center">
                  <span className="font-nunito text-[10px] text-purple-dark font-bold">Text → Hash</span>
                  <div className="flex items-center gap-1">
                ...
                >
                  <span className="font-nunito text-[10px] text-purple-dark font-bold">Hash → Text</span>
                  <div className="flex items-center gap-1">
