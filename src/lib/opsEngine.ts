...
export const OPS_DEFENSE_CONTROLS: OpsDefenseControl[] = [
  ...
  {
    id: 'vendor-risk-gate',
    name: 'Vendor Risk Gate',
    layer: 'Third Party',
    provider: 'Supply Chain Shield',
    protects: ['osint', 'cert', 'web', 'proxy', 'log'],
    strength: 6,
    description: 'Checks third-party widgets, vendor domains, and trust changes before they affect users.',
    miniGame: 'Approve only the widget route with matching ownership, certificate, and behavior.',
  },
  {
...
const OPS_DEFENSE_LAYER_CONFIG: Array<Omit<OpsDefenseLayerProfile, 'level' | 'power'>> = [
  ...
  },
  {
    key: 'idsLevel',
    label: 'IDS',
    effects: ['log', 'traffic', 'recon', 'osint', 'web'],
    color: '#A3E635',
  },
  {
    key: 'wafLevel',
...
export const OPS_OBJECTIVES: OpsObjective[] = [
  ...
  {
    id: 'popup-consent-trap',
    family: 'Account Takeover',
    title: 'Popup Consent Trap',
    result: 'Fake prompt proof',
    surface: 'Browser prompts + user journey',
    difficulty: 2,
    reward: 325,
    risk: 39,
    description: 'Use OSINT and web context to simulate a deceptive prompt route that browser controls can block.',
    steps: [
      {
        id: 'profile-user-journey',
        title: 'Profile user journey',
        role: 'OSINT',
        accepts: ['osint', 'recon', 'web'],
        creates: ['osint', 'web'],
        result: 'User journey mapped',
        defenderCounters: ['log', 'osint'],
      },
      {
        id: 'stage-fake-prompt',
        title: 'Stage fake browser prompt',
        role: 'Social Web',
        accepts: ['social', 'web', 'payload'],
        creates: ['payload', 'social'],
        result: 'Prompt route staged',
        defenderCounters: ['web', 'payload', 'social'],
      },
      {
        id: 'capture-consent-proof',
        title: 'Capture consent proof',
        role: 'Objective',
        accepts: ['credential', 'session', 'social'],
        creates: ['credential', 'session'],
        result: 'Fake prompt proof captured',
        defenderCounters: ['log', 'patch', 'session'],
      },
    ],
  },
  {
    id: 'third-party-widget-pivot',
    family: 'Web Breach',
    title: 'Third-Party Widget Pivot',
    result: 'Vendor widget proof',
    surface: 'External widget + trust controls',
    difficulty: 3,
    reward: 405,
    risk: 50,
    description: 'Trace a third-party widget relationship and prove a safe sandboxed trust gap.',
    steps: [
      {
        id: 'map-vendor-footprint',
        title: 'Map vendor footprint',
        role: 'OSINT',
        accepts: ['osint', 'dns', 'recon'],
        creates: ['osint', 'web'],
        result: 'Vendor footprint mapped',
        defenderCounters: ['log', 'osint'],
      },
      {
        id: 'verify-widget-trust',
        title: 'Verify widget trust path',
        role: 'Trust',
        accepts: ['cert', 'web', 'proxy', 'log'],
        creates: ['cert', 'session'],
        result: 'Widget trust gap found',
        defenderCounters: ['cert', 'patch', 'log'],
      },
      {
        id: 'stage-sandbox-widget',
        title: 'Stage sandboxed widget payload',
        role: 'Payload',
        accepts: ['payload', 'xss', 'web'],
        creates: ['payload'],
        result: 'Sandboxed widget route opened',
        defenderCounters: ['waf', 'patch', 'web'],
      },
      {
        id: 'pull-widget-proof',
        title: 'Pull vendor-bound proof',
        role: 'Objective',
        accepts: ['exfil', 'crypto', 'session'],
        creates: ['exfil'],
        result: 'Vendor widget proof captured',
        defenderCounters: ['backup', 'log', 'cert'],
      },
    ],
  },
  {
